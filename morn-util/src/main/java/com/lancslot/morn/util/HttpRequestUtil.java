...
public class HttpRequestUtil {
    ...
    public static JSONObject postRequestByApplicationJson(String url , String requestParameter, int connectTimeout , int socketTimeOut) throws HttpRequestException, UnsupportedEncodingException {
        ...
        return JSONObject.parseObject(sendReqeust(httpPost));
    }
     ...
     * @throws HttpRequestException 请求异常
     */
    public static InputStream doGetAndReturnInputStream(String url , int connectTimeout , int socketTimeOut) throws HttpRequestException {
        HttpGet httpGet = new HttpGet(url);
        RequestConfig config = getRequestConfig(connectTimeout , socketTimeOut);
        httpGet.setConfig(config);
        return sendReqeustAndReturnInputStream(httpGet);
    }

    private static InputStream sendReqeustAndReturnInputStream(HttpUriRequest httpUriRequest) throws HttpRequestException {
        HttpClient client = HttpClients.createDefault();
        HttpResponse response;
        try {
            response = client.execute(httpUriRequest);
